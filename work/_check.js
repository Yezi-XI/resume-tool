...
// ── Data ──
const SECTION_LABELS = { education:'教育背景', practical_experience:'实践经验', campus_experience:'校园经历', projects:'项目经历', other:'其他' };
const SECTION_ICONS = { education:'grad', practical_experience:'briefcase', campus_experience:'user', projects:'folder', other:'puzzle' };
const TYPE_OPTS = ['education','practical_experience','campus_experience','projects','other'];
